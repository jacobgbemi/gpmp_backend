...
class DashboardSerializer(serializers.Serializer):
    ...
    approved_variations_total = serializers.DecimalField(max_digits=18, decimal_places=2)
    pending_variations_exposure = serializers.DecimalField(max_digits=18, decimal_places=2)
    revised_approved_budget = serializers.DecimalField(max_digits=18, decimal_places=2)
